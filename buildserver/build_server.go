...
import (
	...
	"github.com/nxpkg/go-langserver/gosrc"
	"github.com/nxpkg/go-langserver/langserver"
	"github.com/nxpkg/go-langserver/langserver/util"
	"github.com/nxpkg/go-langserver/pkg/lsp"
	lspext "github.com/nxpkg/go-lsp/lspext"
...
func (h *BuildHandler) Handle(ctx context.Context, conn *jsonrpc2.Conn, req *jsonrpc2.Request) (result interface{}, err error) {
	...
	default:
		...
		lspext.WalkURIFields(result, nil, func(uri lsp.DocumentURI) lsp.DocumentURI {
			// HACK: Work around https://github.com/nxpkg/nxpkg/issues/10541 by
