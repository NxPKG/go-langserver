package main // import "github.com/nxpkg/go-langserver"
...
import (
	...
	"github.com/nxpkg/go-langserver/debugserver"
	"github.com/nxpkg/go-langserver/tracer"
	"github.com/nxpkg/go-langserver/vfsutil"

	"github.com/prometheus/client_golang/prometheus"

	"github.com/gorilla/websocket"
	"github.com/nxpkg/go-langserver/buildserver"
	"github.com/nxpkg/go-langserver/langserver"
	"github.com/nxpkg/jsonrpc2"
	wsjsonrpc2 "github.com/nxpkg/jsonrpc2/websocket"
...
func run(cfg langserver.Config) error {
	...
	if *useBuildServer {
		...
		// https://github.com/nxpkg/nxpkg/issues/6090
...
//
// This function should only be invoked in editor mode, not in nxpkg.com
// mode, because users running the language server as part of their editor
// generally expect much lower memory usage. In contrast, on nxpkg.com we
