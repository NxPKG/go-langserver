...
class GoLangserver < Formula
  ...
  homepage "https://github.com/nxpkg/go-langserver"
  url "https://github.com/nxpkg/go-langserver/archive/v1.0.0.tar.gz"
  sha256 "e803e69f3df40e6e840d04f648e27ffcfb382ff77899c0c7a7b62cf3b3b277a4"

  head "https://github.com/nxpkg/go-langserver.git"
  ...
  go_resource "github.com/nxpkg/ctxvfs" do
    url "https://github.com/nxpkg/ctxvfs.git",
      :revision => "8e2bd62a565a647defd704af3d81fce05c5f190c"
  end

  go_resource "github.com/nxpkg/jsonrpc2" do
    url "https://github.com/nxpkg/jsonrpc2.git",
